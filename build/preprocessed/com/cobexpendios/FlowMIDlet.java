...
//GEN-LINE:|7-commandAction|66|82-postAction
    ...
    public List getListStart() {
        if (ListStart == null) {//GEN-END:|49-getter|0|49-preInit
            // write pre-init user code here
            ListStart = new List("EXPENDIOS", Choice.IMPLICIT);//GEN-BEGIN:|49-getter|1|49-postInit
    ...
    public void ListStartAction() {//GEN-END:|49-action|0|49-preAction
        ...
        if (__selectedString != null) {
            if (__selectedString.equals("Cobrar")) {//GEN-END:|49-action|1|52-preAction
                // write pre-action user code here
                ...
                // write post-action user code here
            } else if (__selectedString.equals("Entregar")) {//GEN-LINE:|49-action|3|128-preAction
                // write pre-action user code here
                SetEntregaExpendios(true);
                SetEntregaConsignatarias(false);
                switchDisplayable(null, getFileBrowser());//GEN-LINE:|49-action|4|128-postAction
                // write post-action user code here
